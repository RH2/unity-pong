...
_BaseNormal("_BaseNormal", 2D) = "black" {}
_Normal("_Normal", 2D) = "bump" {}
_DetailNormal("_DetailNormal", 2D) = "black" {}
_BaseNormal_I("_BaseNormal_I", Float) = 1
...
float4 Tex2D0=tex2D(_BaseNormal,(IN.uv_BaseNormal.xyxy).xy);
float4 UnpackNormal0=float4(UnpackNormal(Tex2D0).xyz, 1.0);
float4 Multiply0=UnpackNormal0 * _BaseNormal_I.xxxx;
...
float4 Subtract0=Tex2D4.aaaa - _alphaOffset.xxxx;
